...
// to keep track of the current active Editor Tab
  const activeEditorTab = useMemo(
    () => Object.values(editorTabs).find((tab) => tab.isActive === true),
    [editorTabs]
  );

  // handler to update the editor state with the query value
  ...
  // to add a new editor tab handler
  ...
  // to delete an editor tab handler
